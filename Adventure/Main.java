        ...
        while(running) {
            ...
            while(enemyHealth > 0) {
                ...
                if(input.equals("1")) {
                    ...
                    System.out.println("\t> Your strike the " + enemy + " for " + damageDealt + " points.");
                    ...
                    if(numHealthPotions > 0) {
                        ...
                        System.out.println("\t> You have no health potions left! Defeat enemies for the chance to find one.\n");
                    }
            ...
            if(input.equals("1")) {
                System.out.println("----------------------------------------------------");
                System.out.println("You delve deeper in to the Dungeon!");
            }else if(input.equals("2")) {
                System.out.println("----------------------------------------------------");
